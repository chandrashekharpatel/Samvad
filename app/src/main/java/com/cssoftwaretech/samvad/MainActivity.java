...
import com.cssoftwaretech.samvad.teacher.tech_attendance_entry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(),tech_attendance_entry.class));
            }
        });
